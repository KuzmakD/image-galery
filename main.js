...
let query = 'city';
let url = `https://api.unsplash.com/search/photos?query=${query}&per_page=30&orientation=landscape&client_id=SouHY7Uul-OxoMl3LL3c0NkxUtjIrKwf3tsGk1JaiVo`;
...
button.addEventListener('submit', () => {
   ...
   url = `https://api.unsplash.com/search/photos?query=${button.value}&per_page=30&orientation=landscape&client_id=SouHY7Uul-OxoMl3LL3c0NkxUtjIrKwf3tsGk1JaiVo`;
   console.log(url);
   getData()}
)
